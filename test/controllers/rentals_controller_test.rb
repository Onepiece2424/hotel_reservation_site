...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { hotelfee: @rental.hotelfee, staydays: @rental.staydays } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { hotelfee: @rental.hotelfee, staydays: @rental.staydays } }
